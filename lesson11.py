...
#for food in food:
        #print(f"i mary like eating{food} ")
#for mary_fav_food in mary_fav_food:
        #print(f"mary likes eating {food}") 
...
## n is the number of terms, d is the common difference, a is the first term
